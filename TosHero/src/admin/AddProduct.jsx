    ...
    try {
      ...
      uploadTask.on (()=> {
        ...
        getDownloadURL(uploadTask.snapshot.ref).then(async(downloadURL) =>{
          await addDoc (docRef, {
            title: enterTitle,
            short_description: enterShortDesc,
          ...
          <Row>
            <Col lg='12'>
              ...
              <Form onSubmit={addproduct}>
                ...
                <input type='text' placeholder='Double Shot Gun' value={enterTitle} onChange={e=> setEnterTitle(e.target.value)} required/>
                </FormGroup>
                <FormGroup className='form__group'>
                ...
                <span>Price</span>
                <input type='number' placeholder='599kr' value={enterPrice} onChange={e=> setEnterPrice(e.target.value)} required/>
                </FormGroup>
                <FormGroup className='form__group w-50'>
                <span>Category</span>
                <select className='w-100' value={enterCategory} onChange={e=> setEnterCategory(e.target.value)} required>
